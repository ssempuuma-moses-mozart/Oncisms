...
/* #040e8c;space and line comments, in free-spacing mode (aka extended mode, flag x) only.
 */
    add(/(?:\s+|#.*)+/,
        function (match) {
            // Keep tokens separated unless the following token is a quantifier
...
(function (XRegExp) {
    ...
    XRegExp.addUnicodePackage({
        ...
        #040e8c;_Space: "0009-000D0020008500A01680180E2000-200A20282029202F205F3000",
